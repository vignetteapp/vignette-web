...
const Card: React.FC<{
  ...
  <div
    className={`mx-auto w-full max-w-xs rounded-xl bg-white border-gray-100 border dark:border-primary px-5 py-4 text-secondary dark:bg-secondary shadow-lg hover:shadow-xl transition duration-300 ease-in-out ${className}`}
  >
