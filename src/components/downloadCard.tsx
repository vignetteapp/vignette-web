const DownloadCard: React.FC<{
  ...
  <div className="text-center">
    <div
      className={`outline-none rounded-md gradient-secondary animate-gradient m-2 text-white text-2xl font-medium
    ...
    >
      <a href={href}>
        <div className="w-full text-center pt-3">
          ...
          <p className="text-white font-inter font-regular pt-2 text-lg tracking-tight">
            {description}
          </p>
        </div>
      </a>
