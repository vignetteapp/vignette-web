      ...
      <div className=" mx-auto my-auto flex w-full max-w-7xl items-center justify-between  px-6">
        <div className="flex items-center">
          ...
          <div className="mx-8 hidden gap-8 text-sm lg:flex">
            ...
            <Link href="/about" legacyBehavior>{t(`nav:about`)}</Link>
            {/*
            <Link href="/plugins">{t(`nav:plugins`)}</Link> */}

            <Link href="/blog" legacyBehavior>{t(`nav:blog`)}</Link>
          </div>
        </div>
        ...
        <div className=" ml-auto hidden items-center gap-4 sm:flex ">
          ...
          <Link href="https://github.com/vignetteapp" passHref className="outline-none">
          ...
          <Link href="https://twitter.com/vignette_org" passHref className="outline-none">
